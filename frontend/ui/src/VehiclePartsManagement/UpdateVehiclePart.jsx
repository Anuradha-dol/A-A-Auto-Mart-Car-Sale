...
export default function UpdateVehiclePart({ fetchParts }) {
  ...
  const validate = () => {
    ...
    if (Number(form.quantity) <= 0 || isNaN(form.quantity)) {
      newErrors.quantity = "Quantity must be a positive number.";
    }
    if (Number(form.price) <= 0 || isNaN(form.price)) {
            ...
            (field) => (
              <div className="form-group" key={field}>
                ...
                <input
                  ...
                  required
                  min={field === "quantity" || field === "price" ? 1 : undefined} // prevent negative
                />
